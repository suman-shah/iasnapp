...
import com.project75.ioeallsubjectnotes.activities.FullViewEngineeringMathematicsII;
...
public class EngineeringMathematicsII extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.pdf_list_View_EngineeringMathematicsII);
        ...
        String[] story_names = getResources().getStringArray(R.array.Stories_name_EngineeringMathematicsII);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(EngineeringMathematicsII.this, FullViewEngineeringMathematicsII.class);
