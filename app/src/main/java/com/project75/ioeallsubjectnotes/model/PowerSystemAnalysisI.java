...
import com.project75.ioeallsubjectnotes.activities.FullViewPowerSystemAnalysisI;
...
public class PowerSystemAnalysisI extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_power_system_analysis_i);
        listView = findViewById(R.id.pdf_list_View_PowerSystemAnalysisI);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (isNetworkAvailable()) {
                    ...
                    Toast.makeText(PowerSystemAnalysisI.this, "No internet connection", Toast.LENGTH_SHORT).show();
                }
