...
import com.project75.ioeallsubjectnotes.activities.FullViewProjectPartA;

public class ProjectPartA extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.pdf_list_View_ProjectPartA);
        ...
        String[] story_names = getResources().getStringArray(R.array.Stories_name_ProjectPartA);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(ProjectPartA.this, FullViewProjectPartA.class);
