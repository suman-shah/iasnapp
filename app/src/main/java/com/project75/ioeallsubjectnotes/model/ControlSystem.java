...
import com.project75.ioeallsubjectnotes.activities.FullViewControlSystem;
...
public class ControlSystem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.pdf_list_View_ControlSystem);
        ...
        String[] story_names = getResources().getStringArray(R.array.Stories_name_ControlSystemr);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(ControlSystem.this, FullViewControlSystem.class);
