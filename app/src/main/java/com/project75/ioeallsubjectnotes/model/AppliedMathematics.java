...
import com.project75.ioeallsubjectnotes.activities.FullViewAppliedMathematics;
import com.project75.ioeallsubjectnotes.activities.FullViewElectiveIIAppliedPhotovoltaic;

public class AppliedMathematics extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.pdf_list_View_AppliedMathematics);
        ...
        String[] story_names = getResources().getStringArray(R.array.Stories_name_AppliedMathematics);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(AppliedMathematics.this, FullViewAppliedMathematics.class);
