...
import com.project75.ioeallsubjectnotes.activities.FullViewEngineeringChemistry;
...
public class EngineeringChemistry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.pdf_list_View_EngineeringChemistry);
        ...
        String[] story_names = getResources().getStringArray(R.array.Stories_name_EngineeringChemistry);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(EngineeringChemistry.this, FullViewEngineeringChemistry.class);
