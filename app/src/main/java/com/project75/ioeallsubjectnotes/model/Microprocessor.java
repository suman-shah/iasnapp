...
import com.project75.ioeallsubjectnotes.activities.FullViewMicroprocessor;
...
public class Microprocessor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.pdf_list_View_Microprocessor);
        ...
        String[] story_names = getResources().getStringArray(R.array.Stories_name_Microprocessor);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(Microprocessor.this, FullViewMicroprocessor.class);
