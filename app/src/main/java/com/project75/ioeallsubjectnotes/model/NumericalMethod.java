...
import com.project75.ioeallsubjectnotes.activities.FullViewNumericalMethod;
...
public class NumericalMethod extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.pdf_list_View_NumericalMethod);
        ...
        String[] story_names = getResources().getStringArray(R.array.Stories_name_NumericalMethod);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(NumericalMethod.this, FullViewNumericalMethod.class);
