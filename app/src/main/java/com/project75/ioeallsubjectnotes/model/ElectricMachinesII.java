...
public class ElectricMachinesII extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electric_machines_ii);
        listView = findViewById(R.id.pdf_list_View_ElectricMachinesII);
        ...
        String[] story_names = getResources().getStringArray(R.array.Stories_name_ElectricMachinesII);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(ElectricMachinesII.this, FullViewElectricMachinesII.class);
