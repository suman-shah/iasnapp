...
import com.project75.ioeallsubjectnotes.activities.FullViewProjectPartB;

public class ProjectPartB extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_project_part_b);
        listView = findViewById(R.id.pdf_list_View_ProjectPartB);
        ...
        String[] story_names = getResources().getStringArray(R.array.Stories_name_ProjectPartBr);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(ProjectPartB.this, FullViewProjectPartB.class);
