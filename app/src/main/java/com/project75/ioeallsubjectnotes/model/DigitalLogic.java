...
import com.project75.ioeallsubjectnotes.activities.FullViewDigitalLogic;
...
public class DigitalLogic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.pdf_list_View_DigitalLogic);
        ...
        String[] story_names = getResources().getStringArray(R.array.Stories_name_DigitalLogic);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(DigitalLogic.this, FullViewDigitalLogic.class);
