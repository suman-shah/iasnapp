...
import com.project75.ioeallsubjectnotes.activities.FullViewObjectOrientedProgramming;

public class ObjectOrientedProgramming extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.pdf_list_View_ObjectOrientedProgramming);
        ...
        String[] story_names = getResources().getStringArray(R.array.Stories_name_ObjectOrientedProgramming);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(ObjectOrientedProgramming.this, FullViewObjectOrientedProgramming.class);
