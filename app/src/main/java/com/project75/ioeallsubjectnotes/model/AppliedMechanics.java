...
import com.project75.ioeallsubjectnotes.activities.FullViewAppliedMechanics;
import com.project75.ioeallsubjectnotes.activities.FullViewElectiveIIAppliedPhotovoltaic;

public class AppliedMechanics extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_applied_mechanics);
        listView = findViewById(R.id.pdf_list_View_AppliedMechanics);
        ...
        String[] story_names = getResources().getStringArray(R.array.Stories_name_AppliedMechanics);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(AppliedMechanics.this, FullViewAppliedMechanics.class);
