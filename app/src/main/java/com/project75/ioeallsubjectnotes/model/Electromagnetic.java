...
import com.project75.ioeallsubjectnotes.activities.FullViewElectromagnetic;

public class Electromagnetic extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electromagnetic);
        listView = findViewById(R.id.pdf_list_View_Electromagnetic);
        ...
        String[] story_names = getResources().getStringArray(R.array.Stories_name_Electromagnetic);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(Electromagnetic.this, FullViewElectromagnetic.class);
