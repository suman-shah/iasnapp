...
import com.project75.ioeallsubjectnotes.activities.FullViewEngineeringMathematicsI;
...
public class EngineeringMathematicsI extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.pdf_list_View_EngineeringMathematicsI);
        ...
        String[] story_names = getResources().getStringArray(R.array.Stories_name_EngineeringMathematicsI);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(EngineeringMathematicsI.this, FullViewEngineeringMathematicsI.class);
